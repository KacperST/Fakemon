...
def resize_images(dataset_path: str,output_dir_path:str, image_size:Tuple[int, int] =(256, 256)) -> None:
    for file in tqdm(os.listdir(dataset_path)):
        file_path = os.path.join(dataset_path, file)
        I = cv2.imread(file_path)
...
def add_noise(dataset_path: str, output_dir_path:str) -> None:
    for file in tqdm(os.listdir(dataset_path)):
        file_path = os.path.join(dataset_path, file)
        I = cv2.imread(file_path)
        row, col, ch = I.shape
